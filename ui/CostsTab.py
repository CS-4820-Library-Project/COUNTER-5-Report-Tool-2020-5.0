...
class Ui_costs_tab(object):
    def setupUi(self, costs_tab):
        ...
        self.costs_cost_in_local_currency_with_tax_doublespinbox.setProperty("showGroupSeparator", True)
        ...
        self.costs_cost_in_original_currency_doublespinbox.setProperty("showGroupSeparator", True)
        ...
        self.costs_cost_in_local_currency_doublespinbox.setProperty("showGroupSeparator", True)
