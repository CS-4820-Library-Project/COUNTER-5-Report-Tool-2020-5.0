...
class Ui_manage_vendors_tab(object):
    def setupUi(self, manage_vendors_tab):
        ...
        manage_vendors_tab.resize(903, 670)
        icon = QtGui.QIcon()
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/ui/resources/save_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.saveVendorChangesButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/ui/resources/undo_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.undoVendorChangesButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/ui/resources/remove_vendor_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.removeVendorButton.setIcon(icon6)
