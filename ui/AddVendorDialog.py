...
class Ui_addVendorDialog(object):
    def setupUi(self, addVendorDialog):
        ...
        self.non_Sushi_check_box = QtWidgets.QCheckBox(self.frame)
        self.non_Sushi_check_box.setText("")
        self.non_Sushi_check_box.setObjectName("non_Sushi_check_box")
        self.gridLayout_2.addWidget(self.non_Sushi_check_box, 8, 1, 1, 1)
        ...
        self.non_sushi_help_button = QtWidgets.QPushButton(self.frame)
        ...
        self.gridLayout_2.addWidget(self.non_sushi_help_button, 8, 2, 1, 1)
