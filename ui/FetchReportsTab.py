...
class Ui_fetch_reports_tab(object):
    def setupUi(self, fetch_reports_tab):
        ...
        fetch_reports_tab.resize(1259, 820)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.end_date_edit_fetch_month.sizePolicy().hasHeightForWidth())
        self.end_date_edit_fetch_month.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.end_date_edit_fetch_month, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.begin_date_edit_fetch_year, 1, 2, 1, 1)
        self.end_date_edit_fetch_year = QtWidgets.QDateEdit(self.frame_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.end_date_edit_fetch_year.sizePolicy().hasHeightForWidth())
        self.end_date_edit_fetch_year.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.end_date_edit_fetch_year, 3, 2, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.begin_date_edit_fetch_month.sizePolicy().hasHeightForWidth())
        self.begin_date_edit_fetch_month.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.begin_date_edit_fetch_month, 1, 3, 1, 1)
