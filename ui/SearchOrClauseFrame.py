...
class Ui_search_or_clause_parameter_frame(object):
    def setupUi(self, search_or_clause_parameter_frame):
        ...
        search_or_clause_parameter_frame.resize(431, 300)
        ...
        self.gridLayout.addWidget(self.search_value_parameter_label, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.search_field_parameter_label, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.search_value_parameter_lineedit, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.search_field_parameter_combobox, 1, 2, 1, 1)
