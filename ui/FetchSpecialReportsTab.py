...
class Ui_fetch_special_reports_tab(object):
    def setupUi(self, fetch_special_reports_tab):
        ...
        fetch_special_reports_tab.resize(1191, 713)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.end_date_edit_special_month.sizePolicy().hasHeightForWidth())
        self.end_date_edit_special_month.setSizePolicy(sizePolicy)
        self.end_date_edit_special_month.setObjectName("end_date_edit_special_month")
        self.gridLayout_2.addWidget(self.end_date_edit_special_month, 2, 3, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.end_date_edit_special_year.sizePolicy().hasHeightForWidth())
        self.end_date_edit_special_year.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_2.addWidget(self.end_date_edit_special_year, 2, 2, 1, 1)
        self.begin_date_edit_special_month = QtWidgets.QDateEdit(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.begin_date_edit_special_month.sizePolicy().hasHeightForWidth())
        self.begin_date_edit_special_month.setSizePolicy(sizePolicy)
        self.begin_date_edit_special_month.setObjectName("begin_date_edit_special_month")
        self.gridLayout_2.addWidget(self.begin_date_edit_special_month, 1, 3, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.begin_date_edit_special_year.sizePolicy().hasHeightForWidth())
        self.begin_date_edit_special_year.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_2.addWidget(self.begin_date_edit_special_year, 1, 2, 1, 1)
