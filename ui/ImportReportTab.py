...
class Ui_import_report_tab(object):
    def setupUi(self, import_report_tab):
        ...
        self.c4_report_type_equiv_combo_box = QtWidgets.QComboBox(self.frame_4)
        self.c4_report_type_equiv_combo_box.setObjectName("c4_report_type_equiv_combo_box")
        self.verticalLayout_2.addWidget(self.c4_report_type_equiv_combo_box)
