...
class Ui_import_report_tab(object):
    def setupUi(self, import_report_tab):
        ...
        self.c4_files_frame = QtWidgets.QFrame(self.frame_3)
        ...
        self.gridLayout_3.addWidget(self.c4_files_frame, 1, 1, 1, 1)
        self.c4_report_type_combo_box = QtWidgets.QComboBox(self.frame_3)
        self.c4_report_type_combo_box.setObjectName("c4_report_type_combo_box")
        self.gridLayout_3.addWidget(self.c4_report_type_combo_box, 1, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.frame_24 = QtWidgets.QFrame(import_report_tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, import_report_tab):
        ...
        self.label_3.setText(_translate("import_report_tab", "Counter 4"))
        self.label_20.setText(_translate("import_report_tab", "Select Report Type"))
