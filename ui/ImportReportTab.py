...
class Ui_import_report_tab(object):
    def setupUi(self, import_report_tab):
        ...
        self.c4_selected_file_edit = QtWidgets.QLineEdit(self.c4_files_frame)
        self.c4_selected_file_edit.setReadOnly(True)
        self.c4_selected_file_edit.setObjectName("c4_selected_file_edit")
        self.horizontalLayout_16.addWidget(self.c4_selected_file_edit)
