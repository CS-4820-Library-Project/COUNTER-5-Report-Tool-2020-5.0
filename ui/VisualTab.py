...
class Ui_visual_tab(object):
    def setupUi(self, visual_tab):
        ...
        self.top_num_lineEdit = QtWidgets.QSpinBox(self.edit_top_num_frame)
        self.top_num_lineEdit.setGeometry(QtCore.QRect(10, 30, 101, 24))
        self.top_num_lineEdit.setObjectName("top_num_lineEdit")
