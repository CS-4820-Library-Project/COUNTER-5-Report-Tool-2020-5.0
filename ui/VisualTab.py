...
class Ui_visual_tab(object):
    def setupUi(self, visual_tab):
        ...
        self.gridLayout_13.addWidget(self.frame_18, 3, 0, 1, 1)
        ...
        self.label_46.setGeometry(QtCore.QRect(50, 30, 183, 15))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.edit_cost_ratio_frame = QtWidgets.QFrame(self.frame_options)
        self.edit_cost_ratio_frame.setEnabled(True)
        self.edit_cost_ratio_frame.setGeometry(QtCore.QRect(30, 90, 221, 81))
        ...
        self.cost_ratio_option_combobox.setGeometry(QtCore.QRect(10, 50, 171, 26))
        ...
        self.label_47.setGeometry(QtCore.QRect(10, 20, 183, 15))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.calculation_type_combobox = QtWidgets.QComboBox(self.frame_options)
        self.calculation_type_combobox.setGeometry(QtCore.QRect(40, 60, 151, 26))
        self.calculation_type_combobox.setObjectName("calculation_type_combobox")
        self.gridLayout_13.addWidget(self.frame_options, 3, 1, 1, 2)
