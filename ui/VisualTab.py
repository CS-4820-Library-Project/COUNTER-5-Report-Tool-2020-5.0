...
class Ui_visual_tab(object):
    def setupUi(self, visual_tab):
        ...
        self.label_46.setGeometry(QtCore.QRect(10, 0, 183, 15))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.radioButton_5.setGeometry(QtCore.QRect(10, 70, 185, 20))
        self.radioButton_5.setObjectName("radioButton_5")
        self.radioButton_6 = QtWidgets.QRadioButton(self.frame_options)
        self.radioButton_6.setGeometry(QtCore.QRect(10, 100, 185, 20))
        self.radioButton_6.setObjectName("radioButton_6")
        self.radioButton_7 = QtWidgets.QRadioButton(self.frame_options)
        self.radioButton_7.setGeometry(QtCore.QRect(10, 130, 185, 20))
        self.radioButton_7.setObjectName("radioButton_7")
        self.radioButton_8 = QtWidgets.QRadioButton(self.frame_options)
        self.radioButton_8.setGeometry(QtCore.QRect(10, 20, 185, 20))
        self.radioButton_8.setObjectName("radioButton_8")
        self.radioButton_9 = QtWidgets.QRadioButton(self.frame_options)
        self.radioButton_9.setGeometry(QtCore.QRect(10, 160, 111, 20))
        self.radioButton_9.setObjectName("radioButton_9")
        self.radioButton_10 = QtWidgets.QRadioButton(self.frame_options)
        self.radioButton_10.setGeometry(QtCore.QRect(10, 40, 185, 20))
        self.radioButton_10.setObjectName("radioButton_10")
        self.frame = QtWidgets.QFrame(self.frame_options)
        self.frame.setGeometry(QtCore.QRect(140, 20, 131, 151))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.cost_ratio_option_combobox = QtWidgets.QComboBox(self.frame)
        self.cost_ratio_option_combobox.setGeometry(QtCore.QRect(10, 30, 111, 26))
        ...
        self.calculation_type_combobox = QtWidgets.QComboBox(self.frame)
        self.calculation_type_combobox.setGeometry(QtCore.QRect(10, 80, 111, 26))
        self.calculation_type_combobox.setObjectName("calculation_type_combobox")
        self.gridLayout_13.addWidget(self.frame_options, 4, 1, 1, 2)
    ...
    def retranslateUi(self, visual_tab):
        ...
        self.radioButton_8.setText(_translate("visual_tab", "Monthly"))
        self.radioButton_9.setText(_translate("visual_tab", "Cost Ratio"))
        self.radioButton_10.setText(_translate("visual_tab", "Yearly"))
