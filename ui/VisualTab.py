...
class Ui_visual_tab(object):
    def setupUi(self, visual_tab):
        ...
        self.visual_vendor_parameter_label.setGeometry(QtCore.QRect(50, 30, 44, 20))
        ...
        self.option_frame.setGeometry(QtCore.QRect(293, 10, 141, 171))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.edit_cost_ratio_frame.setGeometry(QtCore.QRect(10, 10, 121, 81))
        ...
        self.edit_top_num_frame.setGeometry(QtCore.QRect(10, 100, 121, 61))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
