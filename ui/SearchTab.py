...
class Ui_search_tab(object):
    def setupUi(self, search_tab):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 836, 174))
        ...
        self.search_control_frame = QtWidgets.QFrame(self.search_parameters_frame)
        ...
        self.verticalLayout_10.addWidget(self.search_control_frame)
