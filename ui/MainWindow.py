...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.search_report_parameter_frame = QtWidgets.QFrame(self.search_parameters_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.search_report_parameter_frame.sizePolicy().hasHeightForWidth())
        self.search_report_parameter_frame.setSizePolicy(sizePolicy)
        self.search_report_parameter_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.search_report_parameter_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.search_report_parameter_frame.setObjectName("search_report_parameter_frame")
        self.formLayout_6 = QtWidgets.QFormLayout(self.search_report_parameter_frame)
        self.formLayout_6.setObjectName("formLayout_6")
        self.search_report_parameter_label = QtWidgets.QLabel(self.search_report_parameter_frame)
        self.search_report_parameter_label.setObjectName("search_report_parameter_label")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.search_report_parameter_label)
        self.search_reportparameter_combobox = QtWidgets.QComboBox(self.search_report_parameter_frame)
        self.search_reportparameter_combobox.setObjectName("search_reportparameter_combobox")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.search_reportparameter_combobox)
        self.verticalLayout_10.addWidget(self.search_report_parameter_frame)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 858, 159))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
