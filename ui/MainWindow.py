...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.costs_tab = QtWidgets.QWidget()
        self.costs_tab.setObjectName("costs_tab")
        self.verticalLayout_18 = QtWidgets.QVBoxLayout(self.costs_tab)
        self.verticalLayout_18.setObjectName("verticalLayout_18")
        self.costs_parameters_frame = QtWidgets.QFrame(self.costs_tab)
        ...
        self.verticalLayout_18.addWidget(self.costs_parameters_frame)
        self.costs_values_frame = QtWidgets.QFrame(self.costs_tab)
        ...
        self.costs_cost_in_original_currency_lineedit = QtWidgets.QLineEdit(self.costs_values_frame)
        self.costs_cost_in_original_currency_lineedit.setEnabled(False)
        self.costs_cost_in_original_currency_lineedit.setObjectName("costs_cost_in_original_currency_lineedit")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.costs_cost_in_original_currency_lineedit)
        ...
        self.costs_cost_in_local_currency_lineedit = QtWidgets.QLineEdit(self.costs_values_frame)
        self.costs_cost_in_local_currency_lineedit.setEnabled(False)
        self.costs_cost_in_local_currency_lineedit.setObjectName("costs_cost_in_local_currency_lineedit")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.costs_cost_in_local_currency_lineedit)
        ...
        self.costs_cost_in_local_currency_with_tax_lineedit = QtWidgets.QLineEdit(self.costs_values_frame)
        self.costs_cost_in_local_currency_with_tax_lineedit.setEnabled(False)
        self.costs_cost_in_local_currency_with_tax_lineedit.setObjectName("costs_cost_in_local_currency_with_tax_lineedit")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.costs_cost_in_local_currency_with_tax_lineedit)
        self.verticalLayout_18.addWidget(self.costs_values_frame)
        self.costs_control_frame = QtWidgets.QFrame(self.costs_tab)
        ...
        self.verticalLayout_18.addWidget(self.costs_control_frame)
        self.tabWidget.addTab(self.costs_tab, "")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1015, 44))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.settings_database_frame = QtWidgets.QFrame(self.frame_37)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.settings_database_frame.sizePolicy().hasHeightForWidth())
        self.settings_database_frame.setSizePolicy(sizePolicy)
        self.settings_database_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.settings_database_frame.setObjectName("settings_database_frame")
        self.gridLayout_12 = QtWidgets.QGridLayout(self.settings_database_frame)
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.settings_restore_database_button = QtWidgets.QPushButton(self.settings_database_frame)
        self.settings_restore_database_button.setObjectName("settings_restore_database_button")
        self.gridLayout_12.addWidget(self.settings_restore_database_button, 1, 0, 1, 1)
        self.settings_database_label = QtWidgets.QLabel(self.settings_database_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.settings_database_label.sizePolicy().hasHeightForWidth())
        self.settings_database_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.settings_database_label.setFont(font)
        self.settings_database_label.setObjectName("settings_database_label")
        self.gridLayout_12.addWidget(self.settings_database_label, 0, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.gridLayout_10.addWidget(self.settings_database_frame, 2, 0, 1, 1)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.costs_report_parameter_label.setText(_translate("mainWindow", "Report"))
        self.costs_vendor_parameter_label.setText(_translate("mainWindow", "Vendor"))
        self.costs_year_parameter_label.setText(_translate("mainWindow", "Year"))
        self.costs_year_parameter_dateedit.setDisplayFormat(_translate("mainWindow", "yyyy"))
        self.costs_name_parameter_label.setText(_translate("mainWindow", "Name"))
        self.costs_cost_in_original_currency_label.setText(_translate("mainWindow", "Cost in Original Currency"))
        self.costs_original_currency_label.setText(_translate("mainWindow", "Original Currency"))
        self.costs_cost_in_local_currency_label.setText(_translate("mainWindow", "Cost in Local Currency"))
        self.costs_cost_in_local_currency_with_tax_label.setText(_translate("mainWindow", "Cost in Local Currency with Tax"))
        self.costs_load_button.setText(_translate("mainWindow", "Load"))
        self.costs_insert_button.setText(_translate("mainWindow", "Insert"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.costs_tab), _translate("mainWindow", "Costs"))
        ...
        self.settings_restore_database_button.setText(_translate("mainWindow", "Restore Report Database"))
        self.settings_database_label.setText(_translate("mainWindow", "Database"))
