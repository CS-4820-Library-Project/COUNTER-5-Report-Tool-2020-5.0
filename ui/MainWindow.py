...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.nameEdit = QtWidgets.QLineEdit(self.frame_9)
        ...
        self.customerIdEdit = QtWidgets.QLineEdit(self.frame_9)
        ...
        self.baseUrlEdit = QtWidgets.QLineEdit(self.frame_9)
        ...
        self.requestorIdEdit = QtWidgets.QLineEdit(self.frame_9)
        ...
        self.apiKeyEdit = QtWidgets.QLineEdit(self.frame_9)
        ...
        self.platformEdit = QtWidgets.QLineEdit(self.frame_9)
        ...
        self.modifyVendorFrame = QtWidgets.QFrame(self.frame)
        self.modifyVendorFrame.setEnabled(False)
        self.modifyVendorFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.modifyVendorFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.modifyVendorFrame.setObjectName("modifyVendorFrame")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.modifyVendorFrame)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.saveVendorChangesButton = QtWidgets.QPushButton(self.modifyVendorFrame)
        ...
        self.undoVendorChangesButton = QtWidgets.QPushButton(self.modifyVendorFrame)
        ...
        self.removeVendorButton = QtWidgets.QPushButton(self.modifyVendorFrame)
        self.removeVendorButton.setObjectName("removeVendorButton")
        self.horizontalLayout_5.addWidget(self.removeVendorButton)
        self.verticalLayout.addWidget(self.modifyVendorFrame)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_4.setText(_translate("mainWindow", "Requestor ID (oprtional)"))
        self.label_5.setText(_translate("mainWindow", "API Key (optional)"))
        self.label_6.setText(_translate("mainWindow", "Platform (optional)"))
        ...
        self.fetch_advanced_button.setText(_translate("mainWindow", "Fetch Selected Report"))
        ...
        self.label_16.setText(_translate("mainWindow", "(Optional)"))
