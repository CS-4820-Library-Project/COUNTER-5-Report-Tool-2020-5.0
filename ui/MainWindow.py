...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.custom_dir_frame = QtWidgets.QFrame(self.frame_7)
        ...
        self.verticalLayout_7.addWidget(self.custom_dir_frame)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 918, 335))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.search_control_frame = QtWidgets.QFrame(self.search_tab)
        ...
        self.verticalLayout_8.addWidget(self.search_control_frame)
        ...
        self.search_parameters_frame_2 = QtWidgets.QFrame(self.tab)
        self.search_parameters_frame_2.setGeometry(QtCore.QRect(10, 0, 946, 101))
        ...
        self.search_control_frame_2 = QtWidgets.QFrame(self.tab)
        self.search_control_frame_2.setGeometry(QtCore.QRect(10, 500, 946, 80))
        ...
        self.vertical_axis_lineEdit.setGeometry(QtCore.QRect(170, 180, 271, 21))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.url_validation_label.setText(_translate("mainWindow", "Validation label"))
        ...
        self.label_38.setText(_translate("mainWindow", "Not a yearly date range"))
        self.label_41.setText(_translate("mainWindow", "Report(s) will be saved to:"))
        self.custom_dir_button.setText(_translate("mainWindow", "Change"))
        ...
        self.search_open_results_checkbox.setText(_translate("mainWindow", "Open Results"))
        self.search_export_button.setText(_translate("mainWindow", "Export Search"))
        self.search_import_button.setText(_translate("mainWindow", "Import Search"))
        ...
        self.settings_restore_database_button.setText(_translate("mainWindow", "Restore Database"))
        ...
        self.label_73.setText(_translate("mainWindow", "User Agent"))
        self.user_agent_help_button.setText(_translate("mainWindow", "?"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.settings_tab), _translate("mainWindow", "Settings"))
        self.search_start_year_parameter_label_2.setText(_translate("mainWindow", "Start Year"))
        self.search_report_parameter_label_2.setText(_translate("mainWindow", "Report"))
        self.search_end_year_parameter_label_2.setText(_translate("mainWindow", "End year"))
        self.search_start_year_parameter_dateedit_2.setDisplayFormat(_translate("mainWindow", "yyyy"))
        self.search_end_year_parameter_dateedit_2.setDisplayFormat(_translate("mainWindow", "yyyy"))
        self.create_chart_button.setText(_translate("mainWindow", "Create Chart"))
        self.label_8.setText(_translate("mainWindow", "Name *   :"))
        self.label_14.setText(_translate("mainWindow", "Metric Type *   :"))
        self.label_15.setText(_translate("mainWindow", "Required fields*"))
        self.label_46.setText(_translate("mainWindow", "IMPORTANT"))
        self.label_47.setText(_translate("mainWindow", " Name must correspond to Report:"))
        self.label_48.setText(_translate("mainWindow", "Examples : Report is PR, Name must be a Platform"))
        self.label_49.setText(_translate("mainWindow", "Report is DR, Name must be a Database"))
        self.label_50.setText(_translate("mainWindow", "Report is TR, Name must be a Title"))
        self.label_45.setText(_translate("mainWindow", "Select Chart Type"))
        self.radioButton.setText(_translate("mainWindow", "Horizontal Bar"))
        self.radioButton_3.setText(_translate("mainWindow", "Vertical Bar"))
        self.radioButton_4.setText(_translate("mainWindow", "Line"))
        self.label_16.setText(_translate("mainWindow", "File Name     :"))
        self.label_36.setText(_translate("mainWindow", "Chart Title    :"))
        self.label_40.setText(_translate("mainWindow", "Required fields*"))
        self.label_42.setText(_translate("mainWindow", "Customize Chart"))
        self.label_43.setText(_translate("mainWindow", "Horizontal Axis Title     :"))
        self.label_44.setText(_translate("mainWindow", "Vertical Axis Title    :"))
