...
class Ui_settings_tab(object):
    def setupUi(self, settings_tab):
        ...
        self.settings_search_fram = QtWidgets.QFrame(self.frame_37)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.settings_rebuild_database_button = QtWidgets.QPushButton(self.settings_search_fram)
        ...
        self.gridLayout_10.addWidget(self.settings_search_fram, 3, 0, 1, 1)
        ...
        self.settings_costs_frame = QtWidgets.QFrame(self.frame_37)
        ...
        self.gridLayout_10.addWidget(self.settings_costs_frame, 2, 0, 1, 1)
